...
ActiveRecord::Schema.define(version: 20150530221625) do
  ...
  add_index "song_genres", ["song_id", "genre_id"], name: "index_song_genres_on_song_id_and_genre_id", unique: true
  add_index "song_genres", ["song_id"], name: "index_song_genres_on_song_id"
  add_index "song_genres", ["user_id"], name: "index_song_genres_on_user_id"
